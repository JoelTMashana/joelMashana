<?php
	...
	$url= 'api.geonames.org/countryCodeJSON?formatted=true&lat=' . $_POST['latitude'] . '&lng=' . $_POST['longitude'] . '&radius=10&username=joelmashana';
	...
	$output['status'] = $url;
	$output['data'] = $countryInfoDecode['countryCode'];
