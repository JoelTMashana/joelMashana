<?php
	...
	$url='http://api.openweathermap.org/data/2.5/forecast/weather?lat=' . $_POST['latitude'] . '&lon=' . $_POST['longitude'] . '&cnt=10' . '&appid=d24dbe12c720afa869a1120f204c6c05';
	...
	$output['data']['weather'] = $countryInfoDecode;
