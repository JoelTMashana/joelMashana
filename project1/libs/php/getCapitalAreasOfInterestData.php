<?php
	...
	$url='api.geonames.org/findNearbyWikipediaJSON?lang=en&lat=' . $_POST['latitude'] . '&lng=' . $_POST['longitude'] . '&country=' . $_POST['isocode'] . '&radius=10&maxRows=10&username=joelmashana';
	...
	$output['status'] = $url;
	$output['data'] = $countryInfoDecode['geonames'];
